...
config(['$routeProvider', function($routeProvider) {
  ...
  $routeProvider.when('/view19', {templateUrl: 'partials/partial19.html', controller: 'MyCtrl18'});
  $routeProvider.when('/view20', {templateUrl: 'partials/partial20.html', controller: 'MyCtrl19'});
